...
const giveawaysTable: TableData = {
    name: "giveaways",
    autoSetUid: true,
    fields: [
        ...baseFields,
        {name: "guild_id",            type: "text",   sqlType: "text",      notNull: true},
        {name: "prize",               type: "text",   sqlType: "text",      notNull: true},
        {name: "description",         type: "text",   sqlType: "text",      default: sqlValue("")},
        {name: "channel_id",          type: "text",   sqlType: "text",      notNull: true},
        {name: "channel_name",        type: "text",   sqlType: "text",      notNull: true},
        {name: "winner_count",        type: "number", sqlType: "integer",   notNull: true, default: sqlValue(1)},
        {name: "start_at",            type: "date",   sqlType: "timestamp"},
        {name: "ends_at",             type: "date",   sqlType: "timestamp", notNull: true},
        {name: "status",              type: "text",   sqlType: "text",      notNull: true, default: sqlValue("active")},
        {name: "participants",        type: "number", sqlType: "integer",   notNull: true, default: sqlValue(0)},
        {name: "winners",             type: "json",   sqlType: "json",      default: sqlValue("[]")},
        {name: "required_role_ids",   type: "json",   sqlType: "json",      default: sqlValue("[]")},
        {name: "required_role_names", type: "json",   sqlType: "json",      default: sqlValue("[]")},
        {name: "bonus_roles",         type: "json",   sqlType: "json",      default: sqlValue("[]")},
        {name: "created_by",          type: "text",   sqlType: "text",      notNull: true},
    ],
    indexes: [
        {fields: "guild_id"},
...
export default {
    tables: [userTable, notesTable, kvStoreTable, giveawaysTable],
    appName: "Sample app",
